        ...
        <section className="container mx-auto px-4 py-8 md:py-16 lg:py-24 flex flex-col lg:flex-row items-center justify-center text-white">
            <div className="lg:w-1/2 mb-12 lg:mb-0">
                ...
                <div className="flex space-x-4">
                    <Button className="bg-gradient-to-r from-color-2 to-color-3 hover:from-color-5 hover:to-color-6 text-white px-8 py-6 sm:text-base rounded-lg font-medium">
                        Get Started
                    </Button>
                    <Button
                        variant="outline"
                        className="text-black border-white hover:text-color-1 px-8 py-6 sm:text-base rounded-lg font-medium"
                    >
                        Learn More
                    </Button>
                </div>
